...
const Biography = () => {
  return (
    <section className="w-full h-fit overflow-hidden">
      <div className="flex pt-20 w-full h-full">
        <div className="w-full flex items-end">
          <Image className="w-full h-fit" src={Damira} alt="Damira" />
        </div>
        <div className="flex flex-col items-start justify-center pl-0 md:pl-14 gap-10">
          <h3 className="text-3xl md:text-5xl xl:text-6xl font-light">
            Želite li da popravite
            <br />{" "}
            <span className="bg-darkBlue text-white font-bold px-2 leading-relaxed">
              vaše zdravlje?
            </span>
          </h3>
          <p className="font-light text-lg w-full md:w-4/5">
